                ...
                >
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        {visionMetadata.screenshot.format.toUpperCase()} •{' '}
                        {visionMetadata.screenshot.sizeKB.toFixed(1)}KB
...
const CodeEditDialogOptimized: React.FC<CodeEditDialogOptimizedProps> = ({
  ...
  const [currentVisionMetadata, setCurrentVisionMetadata] = useState<VisionMetadata | undefined>(
    visionMetadata,
  );
  ...
  const performVisionAnalysis = useCallback(
    async (screenshotDataUrl: string, metadata: VisionMetadata) => {
      ...
      try {
        ...
        const analysisResult = await visionService.analyzeComponent({
          ...
          userPrompt:
            'Analyze this component for visual design, layout, and potential improvements',
