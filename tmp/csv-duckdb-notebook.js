...
const NotebookDataAnalyzer = () => {
  ...
  const renderCellResults = cell => {
    ...
    }, /*#__PURE__*/React.createElement("span", null, cell.results.length, " rows returned"), cell.tableName && /*#__PURE__*/React.createElement("span", {
      style: {
    ...
    }, "Saved as: ", cell.tableName)), /*#__PURE__*/React.createElement("div", {
      style: {
        maxHeight: '400px',
        overflow: 'auto'
      }
    ...
    }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, Object.keys(cell.results[0]).map(key => /*#__PURE__*/React.createElement("th", {
      key: key,
      style: {
        backgroundColor: '#f8f9fa',
        padding: '12px',
    ...
    }, key)))), /*#__PURE__*/React.createElement("tbody", null, cell.results.slice(0, 1000).map((row, index) => /*#__PURE__*/React.createElement("tr", {
      key: index,
      style: {
        backgroundColor: index % 2 === 0 ? '#fff' : '#f8f9fa'
      }
    }, Object.values(row).map((value, cellIndex) => /*#__PURE__*/React.createElement("td", {
      key: cellIndex,
      style: {
        padding: '10px 12px',
  ...
  }, "Data Analysis Notebook"), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      color: '#7f8c8d',
      fontSize: '14px'
    }
  }, "Upload CSV data and build queries that work with previous results")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '12px'
    }
  ...
  }, "\uD83D\uDCC1 Upload CSV"), /*#__PURE__*/React.createElement("button", {
    onClick: addCell,
    disabled: !dataLoaded,
    style: {
      padding: '8px 16px',
  ...
  }, "+ Add Cell")), /*#__PURE__*/React.createElement("input", {
    type: "file",
    ref: fileInputRef,
  ...
  }, globalError), !dataLoaded && !globalError && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '60px 20px',
      backgroundColor: '#fff',
  ...
  }, "No data loaded yet"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: '#95a5a6',
      marginBottom: '20px'
    }
  }, "Upload a CSV file to start analyzing your data"), /*#__PURE__*/React.createElement("button", {
    onClick: triggerFileUpload,
    disabled: globalLoading || !db,
    style: {
      padding: '12px 24px',
  ...
  }, "\uD83D\uDCC1 Upload CSV File")), dataLoaded && cells.map((cell, index) => /*#__PURE__*/React.createElement("div", {
    key: cell.id,
  ...
  }, "SQL Query"), cell.tableName && /*#__PURE__*/React.createElement("span", {
    style: {
      backgroundColor: '#27ae60',
      color: 'white',
      padding: '2px 6px',
  ...
  }, "\u2192 ", cell.tableName)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '8px'
    }
  ...
  }, "\u25B6 Run"), cells.length > 1 && /*#__PURE__*/React.createElement("button", {
  ...
  }, "\uD83D\uDCA1 Available tables: ", availableTables.map((table, idx) => /*#__PURE__*/React.createElement("span", {
    key: table
  ...
  }, table), idx < availableTables.length - 1 ? ', ' : ''))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      color: '#bdc3c7'
    }
  }, "SELECT queries auto-create tables as cell_", index + 1, "_result")), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("kbd", {
    style: {
      padding: '2px 6px',
      backgroundColor: '#ecf0f1',
      borderRadius: '3px'
    }
  }, "Ctrl+Enter"), " to run"))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 20px 20px',
      width: '100%'
    }
  }, renderCellResults(cell)))), dataLoaded && cells.some(cell => cell.executed && cell.tableName) && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '20px',
      width: '100%'
